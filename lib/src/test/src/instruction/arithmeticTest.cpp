...
TEST_F(InstructionArithmeticTest, SBC_IndirectX) {
    ...
    testMemory[0x007C] = 0x10;   // table base
    testMemory[0x007D] = 0x11;   // [1]
    testMemory[0x007E] = 0x12;   // [2]
    testMemory[0x007F] = 0x13;   // [3]
    testMemory[0x0080] = 0x14;   // [4]
    testMemory[0x0081] = 0x15;   // [5]



    // testMemory[0x0081] = 0x30;
...
TEST_F(InstructionArithmeticTest, SBC_IndirectY) {
    ...
    testMemory[0x2062] = 0x20;  // [2]
    testMemory[0x2063] = 0x20;  // [3]
    testMemory[0x2064] = 0x20;  // [4]
    testMemory[0x2065] = 0x00;  // [5]
    testMemory[0x2066] = 0x80;  // [1]
